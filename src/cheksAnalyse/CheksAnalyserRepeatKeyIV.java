 ...
 */
public class CheksAnalyserRepeatKeyIV extends AbstractCheksAnalyser{

    protected final HashSet<String> keys;
    private int lastSize = 0;
    
    public CheksAnalyserRepeatKeyIV(boolean enableLog, AbstractChaoticSystem chaoticSystem) throws Exception {
